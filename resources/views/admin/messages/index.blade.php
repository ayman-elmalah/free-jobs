...
@section('title') {{ title('كل الرسائل') }} @endsection
...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"> التحكم فى الرسائل </li>
    </ol>
  </section>
...
<script>
  ...
  var table = $('#data').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ url('/adminpanel/messages/data') }}',
      columns: [
          {data: 'id', name: 'id'},
          {data: 'name', name: 'name'},
